...
class eTaxReport(Document):
	...
	def save_to_mta(self):
		...
		try:
			...
			frappe.log_error(f"eTax save failed: {str(e)}", "eTax Report")
	...
	def submit_to_mta(self):
		...
		try:
			...
			frappe.log_error(f"eTax submit failed: {str(e)}", "eTax Report")
	...
	def refresh_from_mta(self):
		...
		try:
			...
			frappe.log_error(f"eTax refresh failed: {str(e)}", "eTax Report")
	...
	def _create_submission_log(self, action, result):
		...
		try:
			...
			frappe.log_error(f"Failed to create submission log: {str(e)}", "eTax")
